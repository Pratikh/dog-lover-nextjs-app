...
export default function ProductsList({ productList, message }) {
    return (
        <>
            ...
            <meta name="description" content="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scra" />
...
export async function getServerSideProps(context) {
    ...
    var result = await axios.get("https://api.artoreal.com/rest/V1/lof-producttags/products/" + context.params.id);

    const data = "https://api.artoreal.com/rest/V1/products?&searchCriteria[filterGroups][3][filters][1][field]=status&searchCriteria[filterGroups][3][filters][1][value]=1&searchCriteria[filterGroups][0][filters][0][field]=entity_id&searchCriteria[filterGroups][0][filters][0][value]=" +
